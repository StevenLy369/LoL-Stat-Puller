...
function SummonerInfo(props) {
    ...
    return (
        <React.Fragment>
            ...
            <p>{AccountInfo[0].tier === "PLATINUM" ? <img src= {`https://raw.communitydragon.org/latest/plugins/rcp-be-lol-game-data/global/default/content/src/leagueclient/rankedcrests/05_platinum/images/platinum_baseface_matte.png`} alt="rank metal"/> : null}</p>
